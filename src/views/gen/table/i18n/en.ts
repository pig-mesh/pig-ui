export default {
	gen: {
		...
		backendPathTip: 'Full path to the backend module biz directory, e.g., D:\\data\\pigx\\pigx-upms\\pigx-upms-biz',
		inputBackendPathTip: 'Enter backend path',
		frontendPath: 'Frontend Path',
		frontendPathTip: 'Full path to the frontend directory, e.g., D:\\data\\pigx-ui',
