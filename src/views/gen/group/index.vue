		...
		<div class="layout-padding-auto layout-padding-view">
			...
			<el-row>
				<div class="mb8" style="width: 100%">
					...
					<el-button @click="exportExcel" class="ml10" formDialogRef icon="Download" type="primary" v-auth="'codegen_group_export'">
						{{ $t('common.exportBtn') }}
					</el-button>
					<el-button
						:disabled="multiple"
			...
			>
				...
				<el-table-column :label="$t('common.action')" width="150">
					<template #default="scope">
						...
						<el-button @click="handleDelete([scope.row.id])" text type="primary" v-auth="'codegen_group_del'">{{ $t('common.delBtn') }} </el-button>
					</template>
				</el-table-column>
			</el-table>
