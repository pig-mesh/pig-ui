      ...
      "data": [
        {
          "routeId": "pigx-auth",
          "routeName": "认证中心",
          "predicates": "[{\"args\": {\"_genkey_0\": \"/auth/**\"}, \"name\": \"Path\"}]",
          "filters": "[{\"args\": {}, \"name\": \"ValidateCodeGatewayFilter\"}, {\"args\": {}, \"name\": \"PasswordDecoderFilter\"}]",
          "uri": "lb://pigx-auth",
          "sortOrder": 0,
          "metadata": "{}",
          "createTime": "2023-09-12 20:57:45",
          "updateTime": null,
          "delFlag": "0"
        },
        {
          ...
          "routeName": "代码生成模块",
          "predicates": "[{\"args\": {\"_genkey_0\": \"/gen/**\"}, \"name\": \"Path\"}]",
          "filters": "[]",
          "uri": "lb://pigx-codegen",
          "sortOrder": 0,
          "metadata": "{}",
        ...
        },
        {
          ...
          "predicates": "[{\"args\": {\"_genkey_0\": \"/daemon/**\"}, \"name\": \"Path\"}]",
          "filters": "[]",
        ...
        },
        {
          ...
          "predicates": "[{\"args\": {\"_genkey_0\": \"/job/**\"}, \"name\": \"Path\"}]",
          "filters": "[]",
        ...
        },
        {
          ...
          "routeName": "分布式事务模块",
          "predicates": "[{\"args\": {\"_genkey_0\": \"/tx/**\"}, \"name\": \"Path\"}]",
          "filters": "[]",
        ...
        {
          "routeId": "pigx-oa-platform-ws",
          "routeName": "工作流长链接支持",
          "predicates": "[{\"args\": {\"_genkey_0\": \"/act/ws/**\"}, \"name\": \"Path\"}]",
          "filters": "[]",
        ...
        },
        {
          ...
          "routeName": "微信公众号管理",
          "predicates": "[{\"args\": {\"_genkey_0\": \"/mp/**\"}, \"name\": \"Path\"}]",
          "filters": "[]",
        ...
        },
        {
          ...
          "routeName": "支付管理",
          "predicates": "[{\"args\": {\"_genkey_0\": \"/pay/**\"}, \"name\": \"Path\"}]",
          "filters": "[]",
        ...
        },
        {
          ...
          "routeName": "监控管理",
          "predicates": "[{\"args\": {\"_genkey_0\": \"/monitor/**\"}, \"name\": \"Path\"}]",
          "filters": "[]",
          "uri": "lb://pigx-monitor",
          "sortOrder": 0,
          "metadata": "{}",
        ...
        {
          "routeId": "pigx-jimu-platform",
          "routeName": "积木报表",
          "predicates": "[{\"args\": {\"_genkey_0\": \"/jimu/**\"}, \"name\": \"Path\"}]",
          "filters": "[]",
          "uri": "lb://pigx-jimu-platform",
          "sortOrder": 0,
          "metadata": "{}",
          "createTime": "2023-09-12 20:57:45",
          "updateTime": null,
        ...
        {
          "routeId": "pigx-report-platform",
          "routeName": "大屏设计",
          "predicates": "[{\"args\": {\"_genkey_0\": \"/gv/**\"}, \"name\": \"Path\"}]",
          "filters": "[]",
          "uri": "lb://pigx-report-platform",
          "sortOrder": 0,
          "metadata": "{}",
          "createTime": "2023-09-12 20:57:45",
          "updateTime": null,
        ...
        {
          "routeId": "pigx-app-server",
          "routeName": "APP服务",
          "predicates": "[{\"args\": {\"_genkey_0\": \"/app/**\"}, \"name\": \"Path\"}]",
          "filters": "[]",
          "uri": "lb://pigx-app-server-biz",
          "sortOrder": 0,
          "metadata": "{}",
          "createTime": "2023-09-12 20:57:45",
          "updateTime": null,
        ...
        {
          "routeId": "pigx-flow-task-biz",
          "routeName": "工作流引擎",
          "predicates": "[{\"args\": {\"_genkey_0\": \"**\"}, \"name\": \"Path\"}]",
          "filters": "[]",
          "uri": "lb://pigx-flow-task-biz",
          "sortOrder": 0,
          "metadata": "{}",
          "createTime": "2023-09-12 20:57:45",
          "updateTime": null,
        ...
        },
        {
          ...
          "routeName": "工作流管理模块",
          "predicates": "[{\"args\": {\"_genkey_0\": \"/act/**\"}, \"name\": \"Path\"}]",
          "filters": "[]",
          "uri": "lb://pigx-oa-platform",
          "sortOrder": 0,
          "metadata": "{}",
          "createTime": "2023-10-23 17:57:01",
          "updateTime": null,
          "delFlag": "0"
        },
        {
          ...
          "routeName": "通用权限模块",
          "predicates": "[{\"args\": {\"_genkey_0\": \"/admin/**\"}, \"name\": \"Path\"}]",
          "filters": "[]",
          "uri": "lb://pigx-upms-biz",
          "sortOrder": 0,
          "metadata": "{}",
          "createTime": "2023-10-23 18:19:56",
          "updateTime": null,
          "delFlag": "0"
        }
      ],
