<template>
	...
	<div class="flex gap-4">
		...
		<button
			...
			class="flex-1 flex items-center justify-center h-10 px-4 text-sm font-medium text-gray-700 dark:text-slate-300 bg-white dark:bg-slate-700 border border-gray-300 dark:border-slate-600 rounded-md cursor-pointer transition-all duration-200 hover:bg-blue-50 dark:hover:bg-slate-600 active:scale-[0.98]"
		>
			<svg
