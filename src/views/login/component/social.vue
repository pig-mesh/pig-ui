<template>
  <div class="relative flex justify-center gap-5 w-full ">

    <div @click="handleClick('cp')"
         class="w-full flex items-center justify-center mb-6 md:mb-0 border border-gray-300 hover:bg-blue-100 text-sm text-gray-500 p-3  rounded-lg tracking-wide font-medium  cursor-pointer transition ease-in duration-500">
      <svg t="1697170502708" class="w-4 mr-2" viewBox="0 0 1229 1024" version="1.1"
           xmlns="http://www.w3.org/2000/svg" p-id="1529" xmlns:xlink="http://www.w3.org/1999/xlink">
        <path
    ...
    <div @click="handleClick('dingding')"
         class="w-full flex items-center justify-center mb-6 md:mb-0 border border-gray-300 hover:bg-blue-100 text-sm text-gray-500 p-3  rounded-lg tracking-wide font-medium  cursor-pointer transition ease-in duration-500">
      <svg t="1697170502708" class="w-4 mr-2" viewBox="0 0 1229 1024" version="1.1"
           xmlns="http://www.w3.org/2000/svg" p-id="1529" xmlns:xlink="http://www.w3.org/1999/xlink">
        <path
...
const handleClick = (thirdpart: string) => {
  ...
  if (thirdpart === 'wechat') {
  ...
  } else if (thirdpart === 'cp') {
    const appid = 'wwdfd8cc3eb1127464';
    ...
    const client_id = 'dingdv6z8uszotogmu28';
    url = `https://login.dingtalk.com/oauth2/auth?redirect_uri=${redirect_uri}&response_type=code&client_id=${client_id}&scope=openid&state=DINGTALK-LOGIN&prompt=consent`;
  }
