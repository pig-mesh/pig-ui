<template>
  <div class="layout-padding">
    <div class="layout-padding-auto layout-padding-view">
      ...
      <div
          class="mx-auto overflow-hidden duration-300 transform bg-white rounded-lg shadow-md mt-11 w-100 dark:bg-slate-800 hover:scale-110 hover:shadow-lg">
        <div class="flex items-center justify-center">
          ...
          <h1 class="ml-4 text-lg font-medium text-gray-700 sm:text-2xl dark:text-gray-200">支付宝扫一扫</h1>
        </div>


        <div class="flex items-center justify-center p-4 bg-white dark:bg-slate-700">
          <vue-qrcode
            class="object-cover object-center w-full h-full max-w-[300px] max-h-[300px]"
            :value="url"
            :options="{
              width: 300,
              height: 300,
        ...
        <div class="bg-white dark:bg-slate-800">
          <div class="container px-6 py-2 mx-auto">
            ...
            <div class="mt-6 space-y-8 xl:mt-6" @click="state.type = '0'">
              <div
                  :class="{'border-primary': state.type === '0' ,'flex items-center justify-between max-w-2xl px-8 py-4 mx-auto border  border-gray-300 dark:border-gray-600 cursor-pointer rounded-xl':true}">
                <div class="flex items-center">
                  ...
                  <div class="flex flex-col items-center mx-5 space-y-1">
                    ...
                    <div class="px-2 text-xs text-blue-400 bg-gray-100 rounded-full sm:px-4 sm:py-1 dark:bg-gray-700 ">
                      1% 手续费
                    </div>
                  </div>
                </div>

                <h2 :class="{'text-primary': state.type === '0', 'text-2xl font-semibold sm:text-4xl text-gray-400 dark:text-gray-300':true}">
            ...
            <div class="mt-6 space-y-8 xl:mt-2" @click="state.type = '1'">
              <div
                  :class="{'border-primary': state.type === '1' ,'flex items-center justify-between max-w-2xl px-8 py-4 mx-auto border  border-gray-300 dark:border-gray-600 cursor-pointer rounded-xl':true}">
                <div class="flex items-center">
                  <svg xmlns="http://www.w3.org/2000/svg"
                ...
                <h2 :class="{'text-primary': state.type === '1', 'text-2xl font-semibold sm:text-4xl text-gray-400 dark:text-gray-300':true}">
                  {{ state.amount / 100 }}<span
