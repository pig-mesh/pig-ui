    ...
    <div class="avue-crud">
      ...
      <el-table border
        ...
        <el-table-column prop="type"
          ...
          <template #="scope">
            <el-tag type="success"
                    v-if="scope.row.type === '0'">左菜单</el-tag>
            <el-tag type="success"
                    v-if="scope.row.type === '2'">顶菜单</el-tag>
            <el-tag type="info"
                    v-if="scope.row.type === '1'">按钮</el-tag>
          </template>
        </el-table-column>
        <el-table-column prop="keepAlive"
          ...
          <template #="scope">
            <el-tag type="info"
                    v-if="scope.row.keepAlive === '0'">关闭</el-tag>
            <el-tag type="success"
                    v-if="scope.row.keepAlive === '1'">开启</el-tag>
          </template>
        </el-table-column>
      ...
      <table-form v-if="addOrUpdateVisible"
                  ref="addOrUpdate"
                  @refreshDataList="getList"></table-form>
    </div>
  </basic-container>
</template>
