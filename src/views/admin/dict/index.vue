		...
		<div class="layout-padding-auto layout-padding-view">
			...
			<el-row>
				<div class="mb8" style="width: 100%">
					...
					<el-button :disabled="multiple" icon="Delete" type="primary" class="ml10" v-auth="'sys_dict_del'" @click="handleDelete(selectObjs)">
						{{ $t('common.delBtn') }}
					</el-button>
			...
			<el-table :data="state.dataList" v-loading="state.loading" style="width: 100%" @selection-change="handleSelectionChange">
				<el-table-column align="center" type="selection" :selectable="handleSelectable" width="50"> </el-table-column>
					...
					<template #default="scope">
						...
						<el-tooltip :content="$t('sysdict.deleteDisabledTip')" :disabled="scope.row.systemFlag === 1" placement="top">
							<span style="margin-left: 12px">
								<el-button text type="primary" :disabled="scope.row.systemFlag !== 1" @click="handleDelete([scope.row.id])">
									{{ $t('common.delBtn') }}
								</el-button>
							</span>
						</el-tooltip>
