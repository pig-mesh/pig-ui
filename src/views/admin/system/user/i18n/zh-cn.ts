export default {
	...
	personal: {
		...
		apiKeyNamePlaceholder: '请输入密钥名称，如：生产环境',
		allowedIps: 'IP 白名单',
		allowedIpsPlaceholder: '多个IP用逗号分隔，留空不限制',
		allowedIpsHint: '留空表示不限制来源 IP。多个 IP 用英文逗号分隔，例如：192.168.1.1,10.0.0.1',
		expiresAt: '过期时间',
		...
		neverUsed: '从未使用',
		apiKeyCreated: '密钥已创建',
		apiKeyOnceWarning: '请立即复制保存，此密钥仅显示一次，关闭后无法再次查看',
		copyBtn: '复制',
		copySuccess: '已复制到剪贴板',
		copyFailed: '复制失败',
		deleteApiKeyConfirm: '确认删除该 API 密钥？删除后使用此密钥的应用将无法访问',
		currentPassword: '当前密码',
		currentPasswordRequired: '请输入当前密码',
		currentPasswordPlaceholder: '请输入当前登录密码以验证身份',
		apiKeyLimitReached: '每个用户最多创建5个API密钥',
	},
};
