<template>
	<el-dialog :title="form.leaveId ? $t('common.editBtn') : $t('common.addBtn')" v-model="visible" :close-on-click-modal="false" draggable>
			...
			<el-row :gutter="24">
				...
				<el-col :span="12" class="mb20">
					<el-form-item :label="t('leave.days')" prop="days">
						<el-input-number :min="1" :max="1000" v-model="form.days" :placeholder="t('leave.inputDaysTip')"></el-input-number>
					</el-form-item>
				</el-col>
