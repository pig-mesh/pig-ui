          ...
          <el-tab-pane name="image">
            ...
            <div class="add_but">
              <el-upload :action="actionUrl"
                         ...
                         :data="uploadData">
                <el-button v-if="permissions.mp_wxmaterial_add"
                           size="mini"
            ...
            <div class="waterfall"
              ...
              <div class="waterfall-item"
                ...
                <el-row class="ope-row">
                  <el-button v-if="permissions.mp_wxmaterial_del"
                             type="danger"
                             icon="el-icon-delete"
                             circle
                             @click="delMaterial(item)"></el-button>
                </el-row>
              </div>
            </div>
          ...
          <el-tab-pane name="video">
            ...
            <div class="add_but">
              <el-button v-if="permissions.mp_wxmaterial_add"
                         size="mini"
                         type="primary"
                         @click="handleAddVideo">新建</el-button>
            </div>
            <el-dialog title="新建视频"
              ...
              <el-form :model="uploadData"
                ...
                <el-form-item label="标题"
                  ...
                  <el-input v-model="uploadData.title"
                            placeholder="标题将展示在相关播放页面，建议填写清晰、准确、生动的标题"></el-input>
                </el-form-item>
          ...
          <el-tab-pane name="news">
            ...
            <el-dialog :title="operateMaterial=='add'?'新建图文':'修改图文'"
              ...
              <div class="left">
                <div class="select-item">
                  <div v-for="(news, index) in articlesAdd"
                       :key='news.id'>
                    <div class="news-main father"
                      ...
                      <div class="child"
                           v-if="articlesAdd.length>1">
                        <el-button type="mini"
                                   icon="el-icon-sort-down"
                                   @click="downNews(index)">下移</el-button>
                        <el-button v-if="operateMaterial=='add'"
                                   type="mini"
                                   icon="el-icon-delete"
                    ...
                    <div class="news-main-item father"
                         v-if="index>0"
                         :class="{'activeAddNews': isActiveAddNews == index}"
                         @click="activeNews(index)">
                      ...
                      <div class="child">
                        <el-button v-if="articlesAdd.length > index+1"
                                   type="mini"
                                   icon="el-icon-sort-down"
                        ...
                        <el-button type="mini"
                                   ...
                                   @click="upNews(index)">上移</el-button>
                        <el-button v-if="operateMaterial=='add'"
                                   type="mini"
                                   icon="el-icon-delete"
                                   @click="minusNews(index)">删除
              ...
              <div class="right"
                ...
                <!--富文本编辑器组件-->
                <el-row>
                  <WxEditor v-model="articlesAdd[isActiveAddNews].content"
                ...
                <el-input v-model="articlesAdd[isActiveAddNews].title"
                          placeholder="请输入标题"></el-input>
                <div class="input-tt">作者：</div>
                <el-input v-model="articlesAdd[isActiveAddNews].author"
                          placeholder="请输入作者"></el-input>
                <div class="input-tt">原文地址：</div>
                <el-input v-model="articlesAdd[isActiveAddNews].contentSourceUrl"
                          placeholder="请输入原文地址"></el-input>
              </div>
              <template #footer>
                <div class="dialog-footer">
            ...
            <div class="waterfall"
              ...
              <template v-for="item in tableData">
                <div v-if="item.content && item.content.articles"
                  ...
                  <el-row class="ope-row">
                    <el-button type="primary"
                               icon="el-icon-edit"
                               circle
                               @click="handleEditNews(item)"></el-button>
...
import WxEditor from '@/components/wechat/WxEditor.vue'
