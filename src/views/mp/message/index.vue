<template>
  <div class="app-container">
    ...
    <!-- 发送消息的弹窗 -->
    <el-dialog title="粉丝消息列表" v-model="open" width="50%">
...
<script>
import { Search as ElIconSearch,Refresh as ElIconRefresh,Edit as ElIconEdit } from '@element-plus/icons'import * as dayjs from 'dayjs';
...
accounts: [],
dayjs,
          ElIconSearch,ElIconRefresh,ElIconEdit,
      }
    },
    name: 'MpMessage',
components: {
