  ...
  <el-tabs type="border-card" v-model="objData.type" @tab-click="handleClick">
    ...
    <el-tab-pane name="text">
      <template v-slot:label>
        <span
          ><el-icon><el-icon-document /></el-icon> 文本</span
        >
      </template>
      <el-input
        type="textarea"
          ...
          <el-col :span="12">
            ...
            >
              <el-button type="primary"
                >新建视频<el-icon class="el-icon--right"
    ...
    <el-tab-pane name="news">
      <template v-slot:label>
        <span
          ><el-icon><el-icon-news /></el-icon> 图文</span
        >
      </template>
      <el-row>
            ...
            <div class="thumb-but">
              ...
              >
                <template v-slot:trigger>
                  <el-button size="mini" type="text">本地上传</el-button>
                </template>
                <el-button
                  size="mini"
                  type="text"
