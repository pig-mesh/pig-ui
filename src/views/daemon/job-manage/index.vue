        ...
        <el-card class="layout-padding-auto">
                ...
                <el-form :inline="true" :model="state.queryForm" @keyup.enter="getDataList" ref="queryRef">
                    <el-form-item :label="$t('job.jobName')" prop="jobName">
                        <el-input :placeholder="$t('job.inputjobNameTip')" @keyup.enter="getDataList" clearable
                                  style="width: 240px" v-model="state.queryForm.jobName"/>
                    </el-form-item>
                    <el-form-item :label="$t('job.jobGroup')" prop="jobGroup">
                        <el-input :placeholder="$t('job.inputjobGroupTip')" @keyup.enter="getDataList" clearable
                                  style="width: 240px" v-model="state.queryForm.jobGroup"/>
                    </el-form-item>
            ...
            <el-row>
                <div class="mb8" style="width: 100%">
                    ...
                    <el-button :disabled="multiple" @click="handleDelete(undefined)" class="ml10" formDialogRef icon="Delete"
                               type="primary">
                        {{ $t('common.delBtn') }}
                    </el-button>
            ...
            <el-table :data="state.dataList" @selection-change="handleSelectionChange" style="width: 100%"
                ...
                <el-table-column :label="$t('common.action')" fixed="right" width="300">
                    <template #default="scope">
                        <el-button @click="handleJobLog(scope.row)" size="small" text type="primary">日志</el-button>

                        <el-button @click="handleStartJob(scope.row)" size="small" text type="primary">启动</el-button>

                        <el-button @click="handleShutDownJob(scope.row)" size="small" text type="primary">暂停</el-button>

                        <el-button @click="handleEditJob(scope.row)" size="small" text type="primary">{{
                            $t('common.editBtn') }}
                        </el-button>

                        <el-button @click="handleRunJob(scope.row)" size="small" text type="primary">执行</el-button>


                        <el-button @click="handleDelete(scope.row)" size="small" text type="primary">
                            {{$t('common.delBtn') }}
                        </el-button>
                    </template>
                </el-table-column>
